...
function transaction_exist($connection,$transactions_table_name,$hash){
...
function insert_transactions_db($connection,$transactions,$transactions_table_name,$admin_wallet_address,$block_time){
...
function insert_block_db($connection,$block_content,$blocks_table_name,$transactions_table_name,$admin_wallet_address){
